...
setTimeout(()=>{
    fs.writeFile('./assets/stylesheets/style.css', emptyContent, err => {
        if (err) {
          console.error(err);
        }
         // file written successfully
    });
    fs.writeFile('./assets/scripts/script.js', emptyContent, err => {
        if (err) {
          console.error(err);
        }
         // file written successfully
    ...
    fs.writeFile('./assets/stylesheets/normalize.css', normalizeCSSContent, err => {
        if (err) {
          console.error(err);
        }
         // file written successfully
